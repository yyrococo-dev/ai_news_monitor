"""
ai-dev 예제 스크립트
- 목적: AI 에이전트(ai-dev)가 기능 개발 작업을 수행할 때 dev_skill 규칙을 참조하고 감사 로그를 남기는 예제입니다.
- 동작:
  1. dev_skill 문서(RULES.md)를 로컬에서 확인(요약)
...
DEV_SKILL_DIR = REPO_ROOT / 'dev_skill'
...
def perform_sample_change():
    sample_file = REPO_ROOT / 'dev_skill' / 'examples' / 'sample_change.txt'
